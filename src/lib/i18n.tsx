...
const translations: Record<Language, Translations> = {
  ...
  tr: {
    ...
    'exercise.pec-deck': 'Pec Deck Machine',
    'exercise.push-up': 'Push-Up',
    'exercise.chest-dip': 'Chest Dip',
    'exercise.chest-press-machine': 'Chest Press Machine',
    ...
    'exercise.calf-raise-standing': 'Standing Calf Raise',
    'exercise.calf-raise-seated': 'Seated Calf Raise',
    ...
    'exercise.machine-shoulder-press': 'Machine Shoulder Press',
    'exercise.cable-lateral-raise': 'Cable Lateral Raise',
    'exercise.shrug': 'Barbell Shrug',
    'exercise.bicep-curl': 'Barbell Bicep Curl',
    'exercise.dumbbell-curl': 'Dumbbell Bicep Curl',
    'exercise.hammer-curl': 'Hammer Curl',
    'exercise.preacher-curl': 'Preacher Curl',
    'exercise.incline-curl': 'Incline Dumbbell Curl',
    'exercise.concentration-curl': 'Concentration Curl',
    'exercise.cable-curl': 'Cable Bicep Curl',
    'exercise.tricep-pushdown': 'Tricep Pushdown',
    'exercise.tricep-dip': 'Tricep Dip',
    ...
    'exercise.close-grip-bench': 'Close Grip Bench Press',
    ...
    'exercise.leg-raise': 'Lying Leg Raise',
    ...
    'exercise.ab-wheel-rollout': 'Ab Wheel Rollout',
    'exercise.cable-woodchop': 'Cable Woodchop',
    'exercise.side-plank': 'Side Plank',
    'exercise.v-up': 'V-Up',
    'exercise.flutter-kick': 'Flutter Kick',
    'exercise.hollow-body': 'Hollow Body Hold',
    'exercise.captain-chair-leg-raise': "Captain's Chair Leg Raise",
